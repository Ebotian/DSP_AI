...
void DEV_I2C_Init(char addr) { fd = wiringPiI2CSetup(addr); }
...
UBYTE DEV_I2C_ReadByte(UBYTE reg) { return wiringPiI2CReadReg8(fd, reg); }
...
static UBYTE PCA9685_ReadByte(UBYTE reg) { return DEV_I2C_ReadByte(reg); }
